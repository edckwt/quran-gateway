...
if( is_array($sora) ){
	$sora = ( isset($sora[1]) ? $sora[1] : $sora );
	$l = ( isset($sora[2]) ? $sora[2] : $l );
}
...
function quran_by_sora_replace($t){
...
if( is_array($language) ){
	$language = ( isset($language[1]) ? $language[1] : $language );
}
...
function quran_all_sora_replace($t){
